# main.tf for CI/CD Pipeline with EKS Cluster

provider "aws" {
  region = "us-east-1" # Change to your preferred region
}

# Create a VPC with proper CIDR blocks
...
# Create public subnets (for NAT gateways, ALBs, etc.)
...
# Security Group rule for worker nodes to communicate with the cluster
...
# Security Group rule for cluster communication to nodes
...
resource "aws_instance" "jenkins_server" {
  ami                    = "ami-0261755bbcb8c4a84" # Amazon Linux 2 AMI (adjust for your region)
  instance_type          = "t2.medium"
  subnet_id              = aws_subnet.public_subnet[0].id
  vpc_security_group_ids = [aws_security_group.jenkins_sg.id]
  key_name               = "project_shopify" # Ensure you have this key pair created in AWS
